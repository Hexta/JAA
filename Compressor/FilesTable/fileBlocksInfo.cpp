...
FileBlocksInfo::FileBlocksInfo( const FileBlocksInfo& orig ) : blocksCount( 0 ), blocks( ), nonRecievedblocks( ), id( )
{
...
FileBlocksInfo::FileBlocksInfo( const uint32_t _totalBlocks, unsigned int _id ) : blocksCount( _totalBlocks ), blocks( ), nonRecievedblocks( ), id( _id )
{
