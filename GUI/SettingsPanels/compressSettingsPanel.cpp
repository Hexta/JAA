/* 
 * File:   CompressSettingsPanel.cpp
 * Author: art
 * 
...
CompressSettingsPanel::CompressSettingsPanel( ) : QWidget(  )
{
	QStringList encoderTypes = QStringList( ) << "" << "RLE" << "BWT" << "MTF" << "Huffman";
...
void
CompressSettingsPanel::disableEncoders( )
{
...
void
CompressSettingsPanel::set( unsigned int blockSize, QList< Compressor::CoderTypes> compressSequence )
{
...
void
CompressSettingsPanel::setupWidgetsConnections( )
{
