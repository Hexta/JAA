...
void
CompressorThread::showProgress(float progress, const QString &fileName,
    float speed) {
...
void
CompressorThread::initCompress(const QStringList &iFileNames,
    const QString &destFileName, unsigned int blocksize,
...
void
CompressorThread::showInfo(CompressorStatus::ErrorCode errorCode,
    const QString &fileName, unsigned int id) {
